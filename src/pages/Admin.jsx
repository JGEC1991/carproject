import { useState, useEffect, useCallback } from 'react';
    ...
    const Admin = () => {
      ...
      const handleMaintenanceCadenceChange = async (value) => {
        const newCadence = parseInt(value, 10);
        setMaintenanceCadence(newCadence);
      };

      const saveMaintenanceCadence = async () => {
        try {
          setLoading(true);
          setError(null);
          ...
          const { error: updateError } = await supabase
            .from('organizations')
            .update({ maintenance_cadence_days: maintenanceCadence })
              ...
              <CardBody>
                ...
                <div className="mb-4">
                  ...
                  <Select
                    ...
                    onChange={(value) => handlePermissionChange('delete_activity', value)}
                    className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-none"
                  >
                    <Option value="user">Usuario</Option>
                    <Option value="admin">Administrador</Option>
                ...
                <div className="mb-4">
                  ...
                  <Select
                    ...
                    onChange={(value) => handlePermissionChange('edit_pago_tarifa_status', value)}
                    className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-none"
                  >
                    <Option value="user">Usuario</Option>
                    <Option value="admin">Administrador</Option>
                ...
                <div className="mb-4">
                  ...
                  <Select
                    ...
                    onChange={(value) => handlePermissionChange('edit_vehicle_mileage', value)}
                    className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-none"
                  >
                    <Option value="user">Usuario</Option>
                    <Option value="admin">Administrador</Option>
                ...
                <Button
                  ...
                  disabled={loading}
                >
                  {loading ? 'Saving...' : 'Guardar Permisos'}
                </Button>
              </CardBody>
            </Card>
          )}
              ...
              <CardBody>
                ...
                <div className="mt-4">
                  ...
                  <Select
                    ...
                    onChange={(value) => handleMaintenanceCadenceChange(value)}
                    className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-none"
                  >
                ...
                <Button
                  color="green"
                  onClick={saveMaintenanceCadence}
                  disabled={loading}
                >
                  {loading ? 'Saving...' : 'Guardar Cadencia'}
                </Button>
              </CardBody>
            </Card>
          )}
