      ...
      const handleUpload = async (photo, folder, setPhotoState, fieldName) => {
        ...
        try {
          ...
          const { data: updateData, error: updateError } = await supabase
            .from('vehicles')
            .update({ [fieldName]: fullUrl, [`${fieldName}_date`]: new Date().toISOString() }) // Store upload date
            .eq('id', vehicle.id);
                  ...
                  <div className="relative">
                    ...
                    {vehicle?.front_image_url && (
                      <>
                        ...
                        {vehicle?.front_image_url_date && (
                          <p className="text-xs text-gray-500 mt-1">
                            {t('Ultima actualizacion')}: {timeAgo(vehicle.front_image_url_date)}
                          </p>
                        )}
                      </>
                    )}
                  ...
                  <div className="relative">
                    ...
                    {vehicle?.rear_image_url && (
                      <>
                        ...
                        {vehicle?.rear_image_url_date && (
                          <p className="text-xs text-gray-500 mt-1">
                            {t('Ultima actualizacion')}: {timeAgo(vehicle.rear_image_url_date)}
                          </p>
                        )}
                      </>
                    )}
                  ...
                  <div className="relative">
                    ...
                    {vehicle?.right_image_url && (
                      <>
                        ...
                        {vehicle?.right_image_url_date && (
                          <p className="text-xs text-gray-500 mt-1">
                            {t('Ultima actualizacion')}: {timeAgo(vehicle.right_image_url_date)}
                          </p>
                        )}
                      </>
                    )}
                  ...
                  <div className="relative">
                    ...
                    {vehicle?.left_image_url && (
                      <>
                        ...
                        {vehicle?.left_image_url_date && (
                          <p className="text-xs text-gray-500 mt-1">
                            {t('Ultima actualizacion')}: {timeAgo(vehicle.left_image_url_date)}
                          </p>
                        )}
                      </>
                    )}
                  ...
                  <div className="relative">
                    ...
                    {vehicle?.dashboard_image_url && (
                      <>
                        ...
                        {vehicle?.dashboard_image_url_date && (
                          <p className="text-xs text-gray-500 mt-1">
                            {t('Ultima actualizacion')}: {timeAgo(vehicle.dashboard_image_url_date)}
                          </p>
                        )}
                      </>
                    )}
